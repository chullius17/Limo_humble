...
class LaneDetector(Node):
    ...
    def __init__(self):
        ...
        # ROS 2 Publishers
        self.raw_mask_pub = self.create_publisher(Image, 'limo/ai_cv_package/ai_detection/lane_masks/raw', 10)
        self.image_pub = self.create_publisher(Image, 'limo/ai_cv_package/ai_detection/lane_overlay', 10)
        ...
        # --- PATH RESOLUTION ---
        try:
            package_share_dir = get_package_share_directory('ai_cv_package')
        except Exception:
