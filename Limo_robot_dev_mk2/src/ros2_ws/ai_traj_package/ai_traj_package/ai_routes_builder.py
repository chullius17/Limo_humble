...
class RoutesBuilder(Node):
    ...
    def __init__(self):
        super().__init__('ai_map_to_heatmap_image_publisher')

        # --- PARAMETER DECLARATIONS (WITH DEFAULTS) ---
        self.declare_parameter('map_topic', '/map')
        self.declare_parameter('image_topic', '/limo/ai_routes/global_map_heatmap')
        self.declare_parameter('high_cost_image_topic', '/limo/ai_routes/high_cost_heatmap')
        self.declare_parameter('debug_distance_topic', '/limo/ai_routes/debug_distance_heatmap')
        self.declare_parameter('robot_frame', 'base_footprint')
        self.declare_parameter('update_rate', 0.05) # 20 Hz
        self.declare_parameter('mask_occupancy_topic', '/limo/ai_routes/selected_mask_grid')
