...
class ColorLaneDetector(Node):
    ...
    def __init__(self):
        ...
        self.label_pub = self.create_publisher(
            Image, 'limo/nav_cv_package/detection/lane_labels/raw', output_qos
        )
        self.debug_mask_pub = self.create_publisher(
            CompressedImage,
            'limo/nav_cv_package/detection/lane_masks/compressed',
            output_qos,
        )
        self.debug_overlay_pub = self.create_publisher(
            CompressedImage,
            'limo/nav_cv_package/detection/lane_overlay/compressed',
            output_qos,
        )
