...
from nav_cv_package.boardwalk import (
...
class VisualPtcld(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter(
            'depth_topic',
            'limo/nav_cv_package/depth_correction/depth_corrected/raw')
        self.declare_parameter(
        ...
        self.declare_parameter(
            'pointcloud_topic', 'limo/nav_cv_package/visual_ptcld/points')
        ...
        self.image_sub = self.create_subscription(
            Image,
            'limo/nav_cv_package/detection/lane_labels/raw',
            self.image_callback,
            pipeline_qos,
        )
        ...
        self.debug_pub = self.create_publisher(
            CompressedImage,
            'limo/nav_cv_package/visual_ptcld/curb_points_debug/compressed',
            pipeline_qos,
        )
        self.lines_pub = self.create_publisher(
            CompressedImage,
            'limo/nav_cv_package/visual_ptcld/lines_and_curbs/compressed',
            pipeline_qos,
        )
        self.blue_filter_debug_pub = self.create_publisher(
            CompressedImage,
            'limo/nav_cv_package/visual_ptcld/blue_filter_debug/compressed',
            pipeline_qos,
        )
