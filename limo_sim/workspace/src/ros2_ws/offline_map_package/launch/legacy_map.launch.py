"""Legacy image-BEV mapping pipeline, retained for existing datasets."""
...
def generate_launch_description():
    ...
    map = Node(
        ...
        parameters=[{
            ...
            'cv_grid_topic': (
                '/limo/map_package/offline/cv_map_display/'
                'cv_map_occupancy_grid'
            ),
            'scan_topic': '/scan',
            'output_topic': (
                '/limo/map_package/offline/map/combined_grid'
            ),
            'laser_map_topic': (
                '/limo/map_package/offline/map/laser_map'
            ),
            'cv_map_topic': '/limo/map_package/offline/map/cv_map',
            'street_map_topic': (
                '/limo/map_package/offline/map/street_map'
            ),
            'street_cost_min': 0.0,
    ...
    saver_node = Node(
        ...
        parameters=[{
            ...
            'cv_map_topic': (
                '/limo/map_package/offline/map/cv_map'
            ),
            'street_map_topic': (
                '/limo/map_package/offline/map/street_map'
            ),
            'request_service': (
                '/limo/map_package/offline/map_saver/save_map'
            ),
